...
Version  : 0.4.6
Release  : 30
URL      : https://cpan.metacpan.org/authors/id/B/BI/BIGPRESH/Getopt-Euclid-0.4.6.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/B/BI/BIGPRESH/Getopt-Euclid-0.4.6.tar.gz
...
%prep
%setup -q -n Getopt-Euclid-0.4.6
cd %{_builddir}
tar xf %{_sourcedir}/libgetopt-euclid-perl_0.4.5-2.debian.tar.xz
cd %{_builddir}/Getopt-Euclid-0.4.6
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Getopt-Euclid-0.4.6/deblicense/
